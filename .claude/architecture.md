...
- **processing**: Optional LLM polishing
...
│   └── TextProcessing/        # PromptProcessor, TextProcessor
├── Models/
...
Single-stage text processing pipeline:

- **PromptProcessor**: Optional LLM-based polishing (if persona active)
